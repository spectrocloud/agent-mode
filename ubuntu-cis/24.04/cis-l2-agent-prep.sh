#!/usr/bin/env bash
# cis-l2-agent-prep.sh — Ubuntu 24.04 LTS
#
# Comprehensive prep for a CIS Ubuntu Linux 24.04 LTS Level 2 hardened
...
if is_apply; then
    ...
    # Mask zram-generator if present (Ubuntu 24.04 cloud images enable zram swap)
...
if is_apply; then
    ...
    # Systemd default on Ubuntu 24.04 is shared, but CIS L2 sometimes flips
